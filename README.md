...
- `url_for()` to a blueprint (trusted destination!) should always be used with `_external=True` to simplify the cross-origin nature of having a blog subdomain. This parameter should be default `True` in templates (HTML).
