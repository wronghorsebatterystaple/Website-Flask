...
- Tables:
    ...
    - Insert any inline tag like `<span>` with attributes `data-align-[center/right/top/bottom]` inside any table cell to control its non-default vertical and horizontal alignment
        - Note that this is only needed for reStructuredText grid tables, as they don't render the recommended alternative, [attribute lists](https://python-markdown.github.io/extensions/attr_list/)
