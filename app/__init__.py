...
def create_app(config_class=Config):
    ...
    blog_bp.register_blueprint(blog_blogpage_bp, url_prefix="/all", name="0")
    blog_bp.register_blueprint(blog_blogpage_bp, url_prefix="/professor-google", name="2")
    blog_bp.register_blueprint(blog_blogpage_bp, url_prefix="/writers-block", name="5")
    blog_bp.register_blueprint(blog_blogpage_bp, url_prefix="/writers-unblock", name="6")
